...
-- Створення користувача happy_teacher з паролем 'secure_password'
CREATE USER IF NOT EXISTS 'happy_teacher'@'192.168.%.%' IDENTIFIED BY '1234';

-- Надання всіх привілеїв для бази даних SchoolDB користувачу happy_teacher
GRANT SELECT, INSERT, UPDATE, DELETE, CREATE TEMPORARY TABLES ON SchoolDB.* TO 'happy_teacher'@'192.168.%.%';

-- Застосування привілеїв
FLUSH PRIVILEGES;
